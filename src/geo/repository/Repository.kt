...
interface Repository {
    ...
    //suspend fun getRecommendedGeos(userId: Int, userFavTags:List<FavTag>, type: GeoType): List<Geo>
    suspend fun getNearGeos(userId: Int, geoType:String, point:Point, range: IntRange): FindIterable<Geo>
}